...
func (c *openMatchServiceClient) CreateTicket(ctx context.Context, in *CreateTicketRequest, opts ...grpc.CallOption) (*CreateTicketResponse, error) {
	...
	err := c.cc.Invoke(ctx, OpenMatchService_CreateTicket_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *openMatchServiceClient) ActivateTickets(ctx context.Context, in *ActivateTicketsRequest, opts ...grpc.CallOption) (*ActivateTicketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, OpenMatchService_ActivateTickets_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *openMatchServiceClient) InvokeMatchmakingFunctions(ctx context.Context, in *MmfRequest, opts ...grpc.CallOption) (OpenMatchService_InvokeMatchmakingFunctionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &OpenMatchService_ServiceDesc.Streams[0], OpenMatchService_InvokeMatchmakingFunctions_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &openMatchServiceInvokeMatchmakingFunctionsClient{stream}
...
func (c *openMatchServiceClient) CreateAssignments(ctx context.Context, in *CreateAssignmentsRequest, opts ...grpc.CallOption) (*CreateAssignmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, OpenMatchService_CreateAssignments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *openMatchServiceClient) WatchAssignments(ctx context.Context, in *WatchAssignmentsRequest, opts ...grpc.CallOption) (OpenMatchService_WatchAssignmentsClient, error) {
	stream, err := c.cc.NewStream(ctx, &OpenMatchService_ServiceDesc.Streams[1], OpenMatchService_WatchAssignments_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &openMatchServiceWatchAssignmentsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _OpenMatchService_InvokeMatchmakingFunctions_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OpenMatchServiceServer).InvokeMatchmakingFunctions(m, &openMatchServiceInvokeMatchmakingFunctionsServer{stream})
}
...
func _OpenMatchService_WatchAssignments_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OpenMatchServiceServer).WatchAssignments(m, &openMatchServiceWatchAssignmentsServer{stream})
}
